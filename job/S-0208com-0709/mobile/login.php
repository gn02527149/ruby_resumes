...
if (!isset($_COOKIE['frontend_agency_user_id'])) {
	...
	if (!$info) {
		header("Location:../ajax.php?act=m_logout");
		exit;
	}
}
...
foreach ($tactics as $v) {
	$tactic[$v['id']] = $v;
	$str = mb_substr(strip_tags($v['content']), 0, 40, 'UTF-8') . (strlen($v['content']) > 40 ? '.......' : '');
	$tactics_div .= '<li>
        ...
        <div class="test_msg">
            <div class="test_msg_box">
                <div class="information">
                    <a class="login" href="../ajax.php?act=m_logout">退出登录</a>
                    ...
                    <div class="bd contentAll">
                        ...
                        <div class="info on">
                            ...
                            <div class="datasheets">
                                ...
                                <p class="dateRange">开始日期：<span class="STdate"><input type="text" name="STdate" value="2018-07-03 00:00:00"></span><br/>结束日期：<span class="EDdate"><input type="text" name="EDdate" value="2018-07-03 23:59:59"></span><a class="searchBtn">提交</a></p>
                            ...
                            <div class="downloadQR">
                                <a class="QRcode" href="../images/QRcode.jpg" download="QRcode"><img src="../images/QRcode.jpg" alt=""></a>
                            </div>
                        </div>
                                ...
                                <form>
                                    <div class="textBox">
                                        <span class="emotionList">
                                            <span class="emotion"><img src="../images/smail.png" alt="" srcset=""> 表情 v</span><span class="head">變更頭像 v</span>
...
<!--                                             <li>1</li>
        ...
        <div class="downloadPoster">
            ...
            <div class="data">
                <div class="closeBtn">X</div>
                <span>联系方式：<input type="text" name="poster_connect" placeholder="QQ:785190000"></span>
                <span>推广网址：<input type="text" name="poster_net" placeholder="0208.com"></span>
                <a class="downloadA" href="" download="poster"><button>送出</button></a>
            </div>
        </div>
    </div>
    <!--footer-->
    ...
    <script>
        $(function() {
            ...
            $('.downloadPoster a .closeBtn').click(function() {
                $('.downloadPoster').hide();
            });
