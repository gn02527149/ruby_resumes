    ...
    <div class="top">
        ...
        <div class="test_msg">
            <div class="test_msg_box">
                <div class="inquire" style="display: none;"><input type="text" placeholder="请输入代理帐号" onfocus="this.placeholder=''" onblur="this.placeholder='请输入代理帐号'"><button class="login" data-toggle="modal" data-target="#vipModal"></button></div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="keyaccount">代理账号: <input type="text"></div>
                    <div class="keyverification">验&nbsp; 证&nbsp; 码: <span class="passcode">dg563</span><input type="text"></div>
                </div>
                <div class="modal-footer">
                    <div>
                        <a><button class="closeBtn login" type="button" data-dismiss="modal" aria-label="Close"></button></a>
