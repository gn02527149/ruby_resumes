...
EventUtil.addLoadHandler(function() {
    ...
    function fnSend() {
        ...
        if (reg.test(oConBox.value)) {
            ...
            var oUserNameHtml = oUserName.innerHTML;
            ...
            oLi.innerHTML = "<div class=\"userPic\"><img src=\"" + headSrc + "\"></div>\
                            ...
                            <div class=\"times\"><span>" + format(oDate.getMonth() + 1) + "\u6708" + format(oDate.getDate()) + "\u65e5 " + format(oDate.getHours()) + ":" + format(oDate.getMinutes()) + "</span><a class=\"reply\" href=\"javascript:;\"><i class=\"fas fa-reply\"></i>\u56de\u590d</a><a class=\"like\" href=\"javascript:;\"><i class=\"far fa-heart\"></i>\u9876</a><span class=\"likenum\">(0)</span></div>\
                        </div>";
            //插入元素
