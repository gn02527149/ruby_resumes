var Sprite3D = Sprite3D || {
    isSupported: function() { if (!this._isInit) this._init(); return this._isSupported },
    stage: function(e) {
    ...
    create: function(e) {
        ...
        } else if (e.style.position == "static") { e.style.position = "relative" }
        ...
        for (prop in this._props) { if (this._props.hasOwnProperty(prop)) { e[prop] = this._props[prop] } }
    ...
    box: function(e, t, n, r) {
        ...
        if (arguments.length === 1) {
            ...
            t = e;
            n = e
        } else if (r && typeof r === "string") { this._handleStringArgument(i, r) }
        var s = e * .5,
            o = t * .5,
            u = n * .5;
    ...
    prefix: function(e) { return Sprite3D._browserPrefix + e },
    _isInit: false,
    _isSupported: false,
    ...
    _props: {
        x: function(e) { if (arguments.length) { this._string[this._positions[0]] = e - this._ox; return this } else { return this._string[this._positions[0]] + this._ox } },
        y: function(e) { if (arguments.length) { this._string[this._positions[1]] = e - this._oy; return this } else { return this._string[this._positions[1]] + this._oy } },
        z: function(e) { if (arguments.length) { this._string[this._positions[2]] = e - this._oz; return this } else { return this._string[this._positions[2]] + this._oz } },
        ...
        rotationX: function(e) { if (arguments.length) { this._string[this._positions[3]] = e; return this } else { return this._string[this._positions[3]] } },
        rotationY: function(e) { if (arguments.length) { this._string[this._positions[4]] = e; return this } else { return this._string[this._positions[4]] } },
        rotationZ: function(e) { if (arguments.length) { this._string[this._positions[5]] = e; return this } else { return this._string[this._positions[5]] } },
        ...
        scaleX: function(e) { if (arguments.length) { this._string[this._positions[6]] = e; return this } else { return this._string[this._positions[6]] } },
        scaleY: function(e) { if (arguments.length) { this._string[this._positions[7]] = e; return this } else { return this._string[this._positions[7]] } },
        scaleZ: function(e) { if (arguments.length) { this._string[this._positions[8]] = e; return this } else { return this._string[this._positions[8]] } },
        ...
        transformOrigin: function(e, t) { this.style[Sprite3D._browserPrefix + "TransformOrigin"] = (Number(e) ? e + "px" : e) + " " + (Number(t) ? t + "px" : t); return this },
        ...
        updateJoin: function() { this.style[Sprite3D._transformProperty] = this._string.join(""); return this },
        update: function() {
            var e = "";
        ...
        html: function(e) { if (arguments.length) { this.innerHTML = e; return this } else { return this.innerHTML } return this },
        size: function(e, t) {
            this.style.width = Number(e) ? e + "px" : e;
            this.style.height = Number(t) ? t + "px" : t;
            return this
        },
        bind: function(e) { if (typeof e === "object") { for (var t in e) { this.addEventListener(t, e[t], false) } } else if (arguments.length === 2) { this.addEventListener(arguments[0], arguments[1], false) } return this },
        unbind: function(e) { if (typeof e === "object") { for (var t in e) { this.removeEventListener(t, e[t], false) } } else if (arguments.length === 2) { this.removeEventListener(arguments[0], arguments[1], false) } return this },
        tileWidth: 0,
        tileHeight: 0,
        ...
        tilePosition: function(e, t) { this.style.backgroundPosition = "-" + e * this.tileWidth + "px -" + t * this.tileHeight + "px"; return this },
        set: function(e, t) { this[e] = t; return this }
    }
};
...
Aroma.CSS3DCube.prototype.setup = function(e, t) {
    this.proxy = { x: 0, y: 0, z: 0, rotationX: 0, rotationY: 0, rotationZ: 0, piece: this };
    this.newSource = e;
    this.oldSource = t;
    ...
    for (var n = 0; n < 6; ++n) {
        ...
        } else { this.sides[n].style.backgroundColor = "#" + this.options.sideColor.toString(16) }
    }
