...
<body>
		...
		<div class="service" id="service">
			<div class="service_info">
				<div class="info info_l">
					<a href="{{ $m_setting->link1 }}" target="_blank">
						@if ($m_setting->qq)
							<p class="web">QQ专员:<span class="qqName">{{ $m_setting->qq }}</span></p>
							<p class="mobile">专员:<span class="qqName">{{ $m_setting->qq }}</span></p>
						@endif
						@if ($m_setting->qq_img)
				...
				<div class="info info_r">
					<a href="weixin://">
						@if ($m_setting->wechat)
							...
							<p class="mobile">专员:<span class="wechatName">{{ $m_setting->wechat }}</span></p>
						@endif
	...
	<div class="hint-show">
		...
		<p>本次活动真实有效 劝君莫失良机<br>请在中奖后72小时内联系活动专员进行兑奖</p>
	</div>
	<div class="mask"></div>
